export default {
  ...
  'validation.name.required': 'Por favor insira seu name!',
  'validation.userName.required': 'Por favor insira seu UserNAme!',
  ...
  'menu.systemManage.user': 'Usuário Gestão',
  'menu.systemManage.role': 'Papel Gestão',
  ...
  'app.setting.production.hint':
    ...
    "menu.index":'Encontrado',
    "menu.rankList":'Grass Rank'
};
